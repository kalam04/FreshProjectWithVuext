 <footer class="footer footer-static footer-light noprint" >
     <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2021<a
                 class="ml-25" href="http://yetfix.com/"
                 target="_blank">YetFix Ltd.</a><span class="d-none d-sm-inline-block">, All rights
